        ...
        <div className="container grid md:grid-cols-2 gap-12">
          ...
          <div className="grid sm:grid-cols-2 gap-6 content-start">
            <div className="bg-card rounded-lg shadow p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">+91 75000 00010</p>
            </div>
            <div className="bg-card rounded-lg shadow p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                V.P.O Binjhol, Panipat, Haryana, 132103 <br />
              </p>
            </div>
            <div className="bg-card rounded-lg shadow p-6 text-center sm:col-span-2">
              ...
              <p className="text-sm text-muted-foreground">jrbinjhol@gmail.com</p>
            </div>
          </div>
